describe('StockMock Banking', function() {
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to deposit $10 to the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to deposit $50 to the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to deposit $100 to the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to deposit $500 to the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to deposit $1000 to the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to withdraw $10 from the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to withdraw $50 from the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to withdraw $100 from the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    element(by.model('withdrawAmount')).sendKeys('500');
    element(by.name('withdrawSubmit')).click();

    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to withdraw $500 from the bank?");
    browser.switchTo().alert().accept();
  ...
  element(by.name('balance')).getText().then(function(text) {
    ...
    browser.wait(protractor.ExpectedConditions.alertIsPresent(), 1000);
    expect(browser.switchTo().alert().getText()).toEqual("Are you sure you want to withdraw $1000 from the bank?");
    browser.switchTo().alert().accept();
